...
<h1
  class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 md:text-7xl lg:mt-6 xl:text-6xl"
>
...
<div>
  <img
  class="w-full lg:absolute lg:inset-y-0 lg:left-0 lg:h-full lg:w-auto lg:max-w-none py-10"
  src={Image}
  alt="logo" />
</div>
</div>
