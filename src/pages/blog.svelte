      ...
      <div class="sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-4 space-y-4 sm:space-y-0">
        <div class="bg-white">
          <div>
            <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105">
              <div>
                <img class="w-full" alt="person for post" src="https://i.imgur.com/lmYYa2s.png" />
                <div class="px-4 py-2">
                  ...
                  <button class="mt-12 w-full text-center bg-teal-500 py-2 rounded-lg">Read more</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white">
          <div>
            <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105">
              <div>
                <img class="w-full" alt="papiez giagant" src="https://i.imgur.com/csPYilq.png" />
                <div class="px-4 py-2">
                  <h1 class="text-xl font-gray-700 font-bold">Papież gigant</h1>
                  <!-- <div class="flex space-x-2 mt-2">
                    <span>
        ...
        <div class="bg-white">
          <div>
            <div class="shadow-lg hover:shadow-xl transform transition duration-500 hover:scale-105">
              <div>
                <img class="w-full" alt="person for post" src="https://i.imgur.com/chvO4cX.png" />
                <div class="px-4 py-2">
                  <h1 class="text-xl font-gray-700 font-bold">Papież gigant</h1>
                  <!-- <div class="flex space-x-2 mt-2">
                    <span>
